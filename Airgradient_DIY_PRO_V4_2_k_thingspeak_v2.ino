/*
k mod  para thingspeak - 9-11-2023
...
const int sendToServerInterval = 20000; // ---------------------------------
   ...
   if (currentMillis - previoussendToServer >= sendToServerInterval) {
     previoussendToServer += sendToServerInterval;
      ...
      if(WiFi.status()== WL_CONNECTED){
        ...
        Serial.println("\nChannel update successful. - app.airgradient");
        http.end();
      ...
      if(x == 200){
       Serial.println("\nChannel update successful. - ThingSpeak");
       }
        else{
